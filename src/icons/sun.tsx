...
export const Sun: React.FC<IconProps> = ({
  ...
  return (
    ...
    >
      ...
      <path d="m19.07 4.93-1.41 1.41" ref={dot2Ref} />
      <path d="M20 12h2" ref={dot3Ref} />
      <path d="m17.66 17.66 1.41 1.41" ref={dot4Ref} />
      <path d="M12 20v2" ref={dot5Ref} />
      <path d="m6.34 17.66-1.41 1.41" ref={dot6Ref} />
      <path d="M2 12h2" ref={dot7Ref} />
      <path d="m4.93 4.93 1.41 1.41" ref={dot8Ref} />
    </svg>
  );
};
