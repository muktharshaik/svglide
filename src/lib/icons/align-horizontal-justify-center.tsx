...
export const AlignHorizontalJustifyCenter: React.FC<IconProps> = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <rect width="6" height="14" x="2" y="5" rx="2" ref={chart1Ref} />
      <rect width="6" height="10" x="16" y="7" rx="2" ref={chart2Ref} />
      <path d="M12 2v20" ref={line1Ref} />
    </svg>
  );
};
