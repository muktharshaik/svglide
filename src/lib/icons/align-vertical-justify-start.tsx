...
export const AlignVerticalJustifyStart: React.FC<IconProps> = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <rect width="14" height="6" x="5" y="16" rx="2" ref={chart1Ref} />
      <rect width="10" height="6" x="7" y="6" rx="2" ref={chart2Ref} />
      <path d="M2 2h20" ref={line1Ref} />
    </svg>
  );
};
